...
CREATE TABLE IF NOT EXISTS `quote` (
  ...
  `quote_text_line1` VARCHAR(300) NULL,
  `quote_text_line2` VARCHAR(300) NULL,
  `quote_text_line3` VARCHAR(300) NULL,
  `quote_text_line4` VARCHAR(300) NULL,
  PRIMARY KEY (`idquote`))
ENGINE = InnoDB;
