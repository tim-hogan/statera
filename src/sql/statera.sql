...
CREATE TABLE IF NOT EXISTS `invoice_line` (
  ...
  `invoice_line_description` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `company_style_theme` VARCHAR(20) NULL DEFAULT 'default')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `attachment` (
  ...
  CONSTRAINT `fk_attachment_attachment_group1`
    ...
    REFERENCES `attachment_group` (`idattachment_group`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
